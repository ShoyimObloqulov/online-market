            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    <select class="icons" name="country" value="<?= $country_sess; ?>">
                        <option value=""  disabled selected>Mamlakatingizni tanlang</option>
                        <option value="India">O'zbekistan</option>
                        <option value="Morocco">Russia</option>
                        <option value="Morocco">English</option>
                    </select>
                    <label>Country</label>
                </div>
