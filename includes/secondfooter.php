<footer class="page-footer">
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            <a class="grey-text text-lighten-4 right animated slideInUp wow" href="https://t.me/obloqulov_shoyim"><i class="fa fa-heartbeat animated pulse infinite red-text"></i> Obloqulov Shoyim</a>
        </div>
    </div>
</footer>
